...
$resultado = $conn->query("SELECT * FROM proveedores $where ORDER BY nombre ASC");
?>
...
<div class="container mt-5">
    ...
    <?php elseif (isset($_GET['editado'])): ?>
        <div class="alert alert-warning">✏️ Proveedor actualizado correctamente.</div>
    <?php elseif (isset($_GET['eliminado'])): ?>
        <div class="alert alert-danger">🗑️ Proveedor eliminado correctamente.</div>
    <?php endif; ?>
    ...
    <?php while ($row = $resultado->fetch_assoc()): ?>
        <tr>
            ...
            <td>
                ...
                <a href="eliminar.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('¿Eliminar proveedor?')">Eliminar</a>
            </td>
        </tr>
    <?php endwhile; ?>
</tbody>
